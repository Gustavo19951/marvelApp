...
import {characterPropGet} from '@/paths/character.ts';
...
export const HeroList = () => {
  ...
  //   useInfiniteScroll<Character>(characterPropGet);
  ...
  const items: Character[] = [
    {
      ...
      urls: [
        {
          type: 'detail',
          url: 'http://marvel.com/characters/74/3-d_man?utm_campaign=apiRef&utm_source=93ac342b12b3e8b064c8cb86ca4ac677',
        },
        {
          type: 'wiki',
          url: 'http://marvel.com/universe/3-D_Man_(Chandler)?utm_campaign=apiRef&utm_source=93ac342b12b3e8b064c8cb86ca4ac677',
        },
        {
          type: 'comiclink',
          url: 'http://marvel.com/comics/characters/1011334/3-d_man?utm_campaign=apiRef&utm_source=93ac342b12b3e8b064c8cb86ca4ac677',
        },
      ],
    },
    {
